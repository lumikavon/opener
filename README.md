...
```bash
npm run tauri:build
# Output: src-tauri/target/release/bundle/msi/Opener_1.0.3_x64_en-US.msi
# Output: src-tauri/target/release/bundle/nsis/Opener_1.0.3_x64-setup.exe
```

#### macOS (DMG/App Bundle)
```bash
npm run tauri:build
# Output: src-tauri/target/release/bundle/dmg/Opener_1.0.3_x64.dmg
...
```bash
npm run tauri:build
# Output: src-tauri/target/release/bundle/appimage/opener_1.0.3_amd64.AppImage
# Output: src-tauri/target/release/bundle/deb/opener_1.0.3_amd64.deb
```
